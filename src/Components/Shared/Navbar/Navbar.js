        ...
        <div>
            <div className="navbar bg-slate-100 py-4">
                <div className="navbar-start">
                    ...
                    <label tabIndex={0} className="btn btn-ghost pl-0 btn-circle avatar">
                        <div className="w-8 rounded-full">
                            <img src="https://placeimg.com/80/80/people" alt='' />
                        </div>
                    </label>
                    <Link className="btn btn-ghost normal-case text-lg md:text-3xl pl-0 font-bold text-info">Eye Care BD</Link>
                ...
                <label tabIndex={0} htmlFor="dashBoard-brawer" className="btn btn-ghost lg:hidden">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
                </label>
